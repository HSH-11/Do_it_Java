...
public class ArrayListMethod {
	public static void main(String[] args) {
		...
		// #7. remove(Object o)
		aList3.remove(new Integer(2)); //원소 중 매개변수 입력과 동일한 객체 삭제
		...
		Object[] object = aList3.toArray(); //object 배열로 변환
		System.out.println(Arrays.toString(object)); // [1, 2, 3]

		// #13-1. toArray(T[] t) --> T[]
		Integer[] integer1 = aList3.toArray(new Integer[0]);//aList3의 길이가 new Integer[0]보다 크기가 크므로 그대로 리턴
